...
class AsyncFinnhubClient(BaseFinnhubClient[AsyncRawClient]):
    def __init__(
        self,
        *,
    ...
    async def aggregate_indicator(
        ...
        return (
            await self.with_raw_response.aggregate_indicator(symbol, resolution, request_options=request_options)
        ).unwrap()
    ...
    async def ai_chat(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.ai_chat(search=search, request_options=request_options)).unwrap()
    ...
    async def airline_price_index(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.airline_price_index(airline, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def bank_branch(self, symbol: Any, *, request_options: RequestOptionsOrDict | None = None) -> BankBranchRes:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.bank_branch(symbol, request_options=request_options)).unwrap()
    ...
    async def bond_price(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.bond_price(isin, from_, to, request_options=request_options)).unwrap()
    ...
    async def bond_profile(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.bond_profile(
    ...
    async def bond_tick(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.bond_tick(isin, date, limit, skip, exchange, request_options=request_options)
        ).unwrap()
    ...
    async def bond_yield_curve(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.bond_yield_curve(code, request_options=request_options)).unwrap()
    ...
    async def company_basic_financials(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_basic_financials(symbol, metric, request_options=request_options)
        ).unwrap()
    ...
    async def company_capex_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_capex_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_dps_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_dps_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_earnings(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_earnings(symbol, limit=limit, request_options=request_options)
        ).unwrap()
    ...
    async def company_earnings_quality_score(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_earnings_quality_score(symbol, freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_ebit_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_ebit_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_ebitda_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_ebitda_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_eps_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_eps_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_esg_score(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.company_esg_score(symbol, request_options=request_options)).unwrap()
    ...
    async def company_executive(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.company_executive(symbol, request_options=request_options)).unwrap()
    ...
    async def company_fcf_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_fcf_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_gross_income_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_gross_income_estimates(
    ...
    async def company_historical_esg_score(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_historical_esg_score(symbol, request_options=request_options)
        ).unwrap()
    ...
    async def company_net_income_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_net_income_estimates(
                symbol, freq=freq, request_options=request_options
            )
        ).unwrap()
    ...
    async def company_news(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.company_news(symbol, from_, to, request_options=request_options)).unwrap()
    ...
    async def company_ocf_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_ocf_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def company_peers(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_peers(symbol, grouping=grouping, request_options=request_options)
        ).unwrap()
    ...
    async def company_pretax_income_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_pretax_income_estimates(
                symbol, freq=freq, request_options=request_options
            )
        ).unwrap()
    ...
    async def company_profile(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_profile(
    ...
    async def company_profile2(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_profile2(
                symbol=symbol, isin=isin, cusip=cusip, request_options=request_options
            )
        ).unwrap()
    ...
    async def company_revenue_estimates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.company_revenue_estimates(symbol, freq=freq, request_options=request_options)
        ).unwrap()
    ...
    async def congressional_trading(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.congressional_trading(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def country(self, *, request_options: RequestOptionsOrDict | None = None) -> list[CountryMetadata]:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.country(request_options=request_options)).unwrap()
    ...
    async def covid_19(self, *, request_options: RequestOptionsOrDict | None = None) -> list[CovidInfo]:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.covid_19(request_options=request_options)).unwrap()
    ...
    async def crypto_candles(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.crypto_candles(symbol, resolution, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def crypto_exchanges(self, *, request_options: RequestOptionsOrDict | None = None) -> list[str]:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.crypto_exchanges(request_options=request_options)).unwrap()
    ...
    async def crypto_profile(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.crypto_profile(symbol, request_options=request_options)).unwrap()
    ...
    async def crypto_symbols(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.crypto_symbols(exchange, request_options=request_options)).unwrap()
    ...
    async def earnings_calendar(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.earnings_calendar(
    ...
    async def earnings_call_live(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.earnings_call_live(
    ...
    async def economic_calendar(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.economic_calendar(from_=from_, to=to, request_options=request_options)
        ).unwrap()
    ...
    async def economic_code(self, *, request_options: RequestOptionsOrDict | None = None) -> list[EconomicCode]:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.economic_code(request_options=request_options)).unwrap()
    ...
    async def economic_data(self, code: str, *, request_options: RequestOptionsOrDict | None = None) -> EconomicData:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.economic_data(code, request_options=request_options)).unwrap()
    ...
    async def etfs_allocation(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.etfs_allocation(symbol=symbol, isin=isin, request_options=request_options)
        ).unwrap()
    ...
    async def etfs_country_exposure(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.etfs_country_exposure(
    ...
    async def etfs_holdings(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.etfs_holdings(
    ...
    async def etfs_profile(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.etfs_profile(symbol=symbol, isin=isin, request_options=request_options)
        ).unwrap()
    ...
    async def etfs_sector_exposure(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.etfs_sector_exposure(symbol=symbol, isin=isin, request_options=request_options)
        ).unwrap()
    ...
    async def fda_committee_meeting_calendar(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.fda_committee_meeting_calendar(request_options=request_options)).unwrap()
    ...
    async def filings(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.filings(
                symbol=symbol,
                cik=cik,
    ...
    async def filings_sentiment(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.filings_sentiment(access_number, request_options=request_options)).unwrap()
    ...
    async def financials(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.financials(
    ...
    async def financials_reported(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.financials_reported(
                symbol=symbol,
                cik=cik,
                access_number=access_number,
                freq=freq,
    ...
    async def forex_candles(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.forex_candles(symbol, resolution, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def forex_exchanges(self, *, request_options: RequestOptionsOrDict | None = None) -> list[str]:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.forex_exchanges(request_options=request_options)).unwrap()
    ...
    async def forex_rates(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.forex_rates(base=base, date=date, request_options=request_options)
        ).unwrap()
    ...
    async def forex_symbols(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.forex_symbols(exchange, request_options=request_options)).unwrap()
    ...
    async def fund_ownership(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.fund_ownership(symbol, limit=limit, request_options=request_options)
        ).unwrap()
    ...
    async def global_filings_download(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.global_filings_download(document_id, request_options=request_options)
        ).unwrap()
    ...
    async def global_filings_search(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.global_filings_search(search=search, request_options=request_options)
        ).unwrap()
    ...
    async def global_filings_search_filter(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.global_filings_search_filter(
    ...
    async def historical_employee_count(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.historical_employee_count(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def historical_market_cap(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.historical_market_cap(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def indices_constituents(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.indices_constituents(symbol, request_options=request_options)).unwrap()
    ...
    async def indices_historical_constituents(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.indices_historical_constituents(symbol, request_options=request_options)
        ).unwrap()
    ...
    async def insider_sentiment(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.insider_sentiment(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def insider_transactions(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.insider_transactions(
    ...
    async def institutional_ownership(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.institutional_ownership(
    ...
    async def institutional_portfolio(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.institutional_portfolio(cik, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def institutional_profile(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.institutional_profile(cik=cik, request_options=request_options)).unwrap()
    ...
    async def international_filings(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.international_filings(
    ...
    async def investment_themes(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.investment_themes(theme, request_options=request_options)).unwrap()
    ...
    async def ipo_calendar(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.ipo_calendar(from_, to, request_options=request_options)).unwrap()
    ...
    async def isin_change(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.isin_change(from_, to, request_options=request_options)).unwrap()
    ...
    async def market_holiday(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.market_holiday(exchange, request_options=request_options)).unwrap()
    ...
    async def market_news(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.market_news(category, min_id=min_id, request_options=request_options)
        ).unwrap()
    ...
    async def market_status(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.market_status(exchange, request_options=request_options)).unwrap()
    ...
    async def mutual_fund_country_exposure(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.mutual_fund_country_exposure(
                symbol=symbol, isin=isin, request_options=request_options
            )
        ).unwrap()
    ...
    async def mutual_fund_eet(self, isin: str, *, request_options: RequestOptionsOrDict | None = None) -> MutualFundEet:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.mutual_fund_eet(isin, request_options=request_options)).unwrap()
    ...
    async def mutual_fund_eet_pai(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.mutual_fund_eet_pai(isin, request_options=request_options)).unwrap()
    ...
    async def mutual_fund_holdings(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.mutual_fund_holdings(
    ...
    async def mutual_fund_profile(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.mutual_fund_profile(symbol=symbol, isin=isin, request_options=request_options)
        ).unwrap()
    ...
    async def mutual_fund_sector_exposure(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.mutual_fund_sector_exposure(
                symbol=symbol, isin=isin, request_options=request_options
            )
        ).unwrap()
    ...
    async def news_sentiment(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.news_sentiment(symbol, request_options=request_options)).unwrap()
    ...
    async def newsroom(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.newsroom(symbol, from_=from_, to=to, request_options=request_options)
        ).unwrap()
    ...
    async def ownership(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.ownership(symbol, limit=limit, request_options=request_options)).unwrap()
    ...
    async def pattern_recognition(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.pattern_recognition(symbol, resolution, request_options=request_options)
        ).unwrap()
    ...
    async def press_releases(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.press_releases(symbol, from_=from_, to=to, request_options=request_options)
        ).unwrap()
    ...
    async def price_metrics(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.price_metrics(symbol, date=date, request_options=request_options)).unwrap()
    ...
    async def price_target(self, symbol: str, *, request_options: RequestOptionsOrDict | None = None) -> PriceTarget:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.price_target(symbol, request_options=request_options)).unwrap()
    ...
    async def quote(self, symbol: str, *, request_options: RequestOptionsOrDict | None = None) -> Quote:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.quote(symbol, request_options=request_options)).unwrap()
    ...
    async def recommendation_trends(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.recommendation_trends(symbol, request_options=request_options)).unwrap()
    ...
    async def revenue_breakdown(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.revenue_breakdown(symbol=symbol, cik=cik, request_options=request_options)
        ).unwrap()
    ...
    async def revenue_breakdown2(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.revenue_breakdown2(symbol, request_options=request_options)).unwrap()
    ...
    async def search_in_filing(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.search_in_filing(search=search, request_options=request_options)).unwrap()
    ...
    async def sector_metric(self, region: str, *, request_options: RequestOptionsOrDict | None = None) -> SectorMetric:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.sector_metric(region, request_options=request_options)).unwrap()
    ...
    async def similarity_index(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.similarity_index(
    ...
    async def social_sentiment(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.social_sentiment(symbol, from_=from_, to=to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_basic_dividends(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.stock_basic_dividends(symbol, request_options=request_options)).unwrap()
    ...
    async def stock_bidask(self, symbol: str, *, request_options: RequestOptionsOrDict | None = None) -> LastBidAsk:
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.stock_bidask(symbol, request_options=request_options)).unwrap()
    ...
    async def stock_candles(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_candles(symbol, resolution, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_dividends(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_dividends(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_lobbying(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_lobbying(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_nbbo(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_nbbo(symbol, date, limit, skip, request_options=request_options)
        ).unwrap()
    ...
    async def stock_presentation(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.stock_presentation(symbol, request_options=request_options)).unwrap()
    ...
    async def stock_splits(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.stock_splits(symbol, from_, to, request_options=request_options)).unwrap()
    ...
    async def stock_symbols(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_symbols(
    ...
    async def stock_tick(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_tick(symbol, date, limit, skip, request_options=request_options)
        ).unwrap()
    ...
    async def stock_usa_spending(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_usa_spending(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_uspto_patent(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_uspto_patent(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def stock_visa_application(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.stock_visa_application(symbol, from_, to, request_options=request_options)
        ).unwrap()
    ...
    async def supply_chain_relationships(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.supply_chain_relationships(symbol, request_options=request_options)
        ).unwrap()
    ...
    async def support_resistance(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.support_resistance(symbol, resolution, request_options=request_options)
        ).unwrap()
    ...
    async def symbol_change(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.symbol_change(from_, to, request_options=request_options)).unwrap()
    ...
    async def symbol_search(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.symbol_search(q, exchange=exchange, request_options=request_options)
        ).unwrap()
    ...
    async def technical_indicator(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.technical_indicator(
    ...
    async def transcripts(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.transcripts(id, request_options=request_options)).unwrap()
    ...
    async def transcripts_list(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (await self.with_raw_response.transcripts_list(symbol, request_options=request_options)).unwrap()
    ...
    async def upgrade_downgrade(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.upgrade_downgrade(
...
AsyncClient = AsyncFinnhubClient
