...
```python
result = client.with_raw_response.aggregate_indicator(symbol, resolution)
match result:
...
```python
result = await async_client.with_raw_response.aggregate_indicator(symbol, resolution)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type AggregateIndicators
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[AggregateIndicators](finnhub/models/aggregate_indicators.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[AggregateIndicators](finnhub/models/aggregate_indicators.py)</code> -- successful operation

**On `Failure`**: `error` is <code>[RawError](finnhub/core/results.py)</code>
...
```python
result = client.with_raw_response.ai_chat()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.ai_chat()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type AichatResponse
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[AichatResponse](finnhub/models/aichat_response.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[AichatResponse](finnhub/models/aichat_response.py)</code> -- successful operation
...
```python
result = client.with_raw_response.airline_price_index(airline, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.airline_price_index(airline, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type AirlinePriceIndexData
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[AirlinePriceIndexData](finnhub/models/airline_price_index_data.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[AirlinePriceIndexData](finnhub/models/airline_price_index_data.py)</code> -- successful operation
...
```python
result = client.with_raw_response.bank_branch(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.bank_branch(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BankBranchRes
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BankBranchRes](finnhub/models/bank_branch_res.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BankBranchRes](finnhub/models/bank_branch_res.py)</code> -- successful operation
...
```python
result = client.with_raw_response.bond_price(isin, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.bond_price(isin, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BondCandles
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BondCandles](finnhub/models/bond_candles.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BondCandles](finnhub/models/bond_candles.py)</code> -- successful operation
...
```python
result = client.with_raw_response.bond_profile()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.bond_profile()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BondProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BondProfile](finnhub/models/bond_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BondProfile](finnhub/models/bond_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.bond_tick(isin, date, limit, skip, exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.bond_tick(isin, date, limit, skip, exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BondTickData
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BondTickData](finnhub/models/bond_tick_data.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BondTickData](finnhub/models/bond_tick_data.py)</code> -- successful operation
...
```python
result = client.with_raw_response.bond_yield_curve(code)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.bond_yield_curve(code)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BondYieldCurve
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BondYieldCurve](finnhub/models/bond_yield_curve.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BondYieldCurve](finnhub/models/bond_yield_curve.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_basic_financials(symbol, metric)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_basic_financials(symbol, metric)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type BasicFinancials
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[BasicFinancials](finnhub/models/basic_financials.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[BasicFinancials](finnhub/models/basic_financials.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_capex_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_capex_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CapexEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CapexEstimates](finnhub/models/capex_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CapexEstimates](finnhub/models/capex_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_dps_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_dps_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type DpsEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[DpsEstimates](finnhub/models/dps_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[DpsEstimates](finnhub/models/dps_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_earnings(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_earnings(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[EarningResult]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[EarningResult](finnhub/models/earning_result.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[EarningResult](finnhub/models/earning_result.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.company_earnings_quality_score(symbol, freq)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_earnings_quality_score(symbol, freq)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CompanyEarningsQualityScore
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CompanyEarningsQualityScore](finnhub/models/company_earnings_quality_score.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CompanyEarningsQualityScore](finnhub/models/company_earnings_quality_score.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_ebit_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_ebit_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EbitEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EbitEstimates](finnhub/models/ebit_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EbitEstimates](finnhub/models/ebit_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_ebitda_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_ebitda_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EbitdaEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EbitdaEstimates](finnhub/models/ebitda_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EbitdaEstimates](finnhub/models/ebitda_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_eps_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_eps_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EarningsEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EarningsEstimates](finnhub/models/earnings_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EarningsEstimates](finnhub/models/earnings_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_esg_score(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_esg_score(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CompanyEsg
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CompanyEsg](finnhub/models/company_esg.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CompanyEsg](finnhub/models/company_esg.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_executive(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_executive(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CompanyExecutive
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CompanyExecutive](finnhub/models/company_executive.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CompanyExecutive](finnhub/models/company_executive.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_fcf_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_fcf_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type FcfEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[FcfEstimates](finnhub/models/fcf_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[FcfEstimates](finnhub/models/fcf_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_gross_income_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_gross_income_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type GrossIncomeEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[GrossIncomeEstimates](finnhub/models/gross_income_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[GrossIncomeEstimates](finnhub/models/gross_income_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_historical_esg_score(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_historical_esg_score(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type HistoricalCompanyEsg
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[HistoricalCompanyEsg](finnhub/models/historical_company_esg.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[HistoricalCompanyEsg](finnhub/models/historical_company_esg.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_net_income_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_net_income_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type NetIncomeEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[NetIncomeEstimates](finnhub/models/net_income_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[NetIncomeEstimates](finnhub/models/net_income_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_news(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_news(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CompanyNews]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[CompanyNews](finnhub/models/company_news.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[CompanyNews](finnhub/models/company_news.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.company_ocf_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_ocf_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type OcfEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[OcfEstimates](finnhub/models/ocf_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[OcfEstimates](finnhub/models/ocf_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_peers(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_peers(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;str&#93;, [RawError](finnhub/core/results.py)&#93;</code>
...
```python
result = client.with_raw_response.company_pretax_income_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_pretax_income_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PretaxIncomeEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[PretaxIncomeEstimates](finnhub/models/pretax_income_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[PretaxIncomeEstimates](finnhub/models/pretax_income_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_profile()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_profile()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CompanyProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CompanyProfile](finnhub/models/company_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CompanyProfile](finnhub/models/company_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_profile2()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_profile2()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CompanyProfile2
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CompanyProfile2](finnhub/models/company_profile2.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CompanyProfile2](finnhub/models/company_profile2.py)</code> -- successful operation
...
```python
result = client.with_raw_response.company_revenue_estimates(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.company_revenue_estimates(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type RevenueEstimates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[RevenueEstimates](finnhub/models/revenue_estimates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[RevenueEstimates](finnhub/models/revenue_estimates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.congressional_trading(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.congressional_trading(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CongressionalTrading
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CongressionalTrading](finnhub/models/congressional_trading.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CongressionalTrading](finnhub/models/congressional_trading.py)</code> -- successful operation
...
```python
result = client.with_raw_response.country()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.country()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CountryMetadata]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[CountryMetadata](finnhub/models/country_metadata.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[CountryMetadata](finnhub/models/country_metadata.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.covid_19()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.covid_19()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CovidInfo]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[CovidInfo](finnhub/models/covid_info.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[CovidInfo](finnhub/models/covid_info.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.crypto_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.crypto_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CryptoCandles
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CryptoCandles](finnhub/models/crypto_candles.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CryptoCandles](finnhub/models/crypto_candles.py)</code> -- successful operation
...
```python
result = client.with_raw_response.crypto_exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.crypto_exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
```python
result = client.with_raw_response.crypto_profile(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.crypto_profile(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CryptoProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[CryptoProfile](finnhub/models/crypto_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[CryptoProfile](finnhub/models/crypto_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.crypto_symbols(exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.crypto_symbols(exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CryptoSymbol]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[CryptoSymbol](finnhub/models/crypto_symbol.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[CryptoSymbol](finnhub/models/crypto_symbol.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.earnings_calendar()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.earnings_calendar()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EarningsCalendar
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EarningsCalendar](finnhub/models/earnings_calendar.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EarningsCalendar](finnhub/models/earnings_calendar.py)</code> -- successful operation
...
```python
result = client.with_raw_response.earnings_call_live()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.earnings_call_live()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EarningsCallLive
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EarningsCallLive](finnhub/models/earnings_call_live.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EarningsCallLive](finnhub/models/earnings_call_live.py)</code> -- successful operation
...
```python
result = client.with_raw_response.economic_calendar()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.economic_calendar()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EconomicCalendar
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EconomicCalendar](finnhub/models/economic_calendar.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EconomicCalendar](finnhub/models/economic_calendar.py)</code> -- successful operation
...
```python
result = client.with_raw_response.economic_code()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.economic_code()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[EconomicCode]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[EconomicCode](finnhub/models/economic_code.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[EconomicCode](finnhub/models/economic_code.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.economic_data(code)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.economic_data(code)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EconomicData
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EconomicData](finnhub/models/economic_data.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EconomicData](finnhub/models/economic_data.py)</code> -- successful operation
...
```python
result = client.with_raw_response.etfs_allocation()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.etfs_allocation()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EtfsAllocation
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EtfsAllocation](finnhub/models/etfs_allocation.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EtfsAllocation](finnhub/models/etfs_allocation.py)</code> -- successful operation
...
```python
result = client.with_raw_response.etfs_country_exposure()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.etfs_country_exposure()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EtfsCountryExposure
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EtfsCountryExposure](finnhub/models/etfs_country_exposure.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EtfsCountryExposure](finnhub/models/etfs_country_exposure.py)</code> -- successful operation
...
```python
result = client.with_raw_response.etfs_holdings()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.etfs_holdings()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EtfsHoldings
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EtfsHoldings](finnhub/models/etfs_holdings.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EtfsHoldings](finnhub/models/etfs_holdings.py)</code> -- successful operation
...
```python
result = client.with_raw_response.etfs_profile()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.etfs_profile()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EtfsProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EtfsProfile](finnhub/models/etfs_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EtfsProfile](finnhub/models/etfs_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.etfs_sector_exposure()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.etfs_sector_exposure()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EtfsSectorExposure
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EtfsSectorExposure](finnhub/models/etfs_sector_exposure.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EtfsSectorExposure](finnhub/models/etfs_sector_exposure.py)</code> -- successful operation
...
```python
result = client.with_raw_response.fda_committee_meeting_calendar()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.fda_committee_meeting_calendar()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[FdacomitteeMeeting]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[FdacomitteeMeeting](finnhub/models/fdacomittee_meeting.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[FdacomitteeMeeting](finnhub/models/fdacomittee_meeting.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.filings()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.filings()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[Filing]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[Filing](finnhub/models/filing.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[Filing](finnhub/models/filing.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.filings_sentiment(access_number)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.filings_sentiment(access_number)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SecsentimentAnalysis
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SecsentimentAnalysis](finnhub/models/secsentiment_analysis.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SecsentimentAnalysis](finnhub/models/secsentiment_analysis.py)</code> -- successful operation
...
```python
result = client.with_raw_response.financials(symbol, statement, freq)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.financials(symbol, statement, freq)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type FinancialStatements
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[FinancialStatements](finnhub/models/financial_statements.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[FinancialStatements](finnhub/models/financial_statements.py)</code> -- successful operation
...
```python
result = client.with_raw_response.financials_reported()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.financials_reported()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type FinancialsAsReported
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[FinancialsAsReported](finnhub/models/financials_as_reported.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[FinancialsAsReported](finnhub/models/financials_as_reported.py)</code> -- successful operation
...
```python
result = client.with_raw_response.forex_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.forex_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type ForexCandles
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[ForexCandles](finnhub/models/forex_candles.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[ForexCandles](finnhub/models/forex_candles.py)</code> -- successful operation
...
```python
result = client.with_raw_response.forex_exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.forex_exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
```python
result = client.with_raw_response.forex_rates()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.forex_rates()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Forexrates
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Forexrates](finnhub/models/forexrates.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Forexrates](finnhub/models/forexrates.py)</code> -- successful operation
...
```python
result = client.with_raw_response.forex_symbols(exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.forex_symbols(exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[ForexSymbol]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[ForexSymbol](finnhub/models/forex_symbol.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[ForexSymbol](finnhub/models/forex_symbol.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.fund_ownership(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.fund_ownership(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type FundOwnership
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[FundOwnership](finnhub/models/fund_ownership.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[FundOwnership](finnhub/models/fund_ownership.py)</code> -- successful operation
...
```python
result = client.with_raw_response.global_filings_download(document_id)
match result:
    case Success():
        ...  # 2xx, no content
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.global_filings_download(document_id)
match result:
    case Success():
        ...  # 2xx, no content
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;None, [RawError](finnhub/core/results.py)&#93;</code>
...
```python
result = client.with_raw_response.global_filings_search()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.global_filings_search()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SearchResponse
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SearchResponse](finnhub/models/search_response.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SearchResponse](finnhub/models/search_response.py)</code> -- successful operation
...
```python
result = client.with_raw_response.global_filings_search_filter(field)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.global_filings_search_filter(field)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SearchFilter
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SearchFilter](finnhub/models/search_filter.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SearchFilter](finnhub/models/search_filter.py)</code> -- successful operation
...
```python
result = client.with_raw_response.historical_employee_count(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.historical_employee_count(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type HistoricalEmployeeCount
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[HistoricalEmployeeCount](finnhub/models/historical_employee_count.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[HistoricalEmployeeCount](finnhub/models/historical_employee_count.py)</code> -- successful operation
...
```python
result = client.with_raw_response.historical_market_cap(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.historical_market_cap(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type HistoricalMarketCapData
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[HistoricalMarketCapData](finnhub/models/historical_market_cap_data.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[HistoricalMarketCapData](finnhub/models/historical_market_cap_data.py)</code> -- successful operation
...
```python
result = client.with_raw_response.indices_constituents(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.indices_constituents(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type IndicesConstituents
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[IndicesConstituents](finnhub/models/indices_constituents.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[IndicesConstituents](finnhub/models/indices_constituents.py)</code> -- successful operation
...
```python
result = client.with_raw_response.indices_historical_constituents(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.indices_historical_constituents(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type IndicesHistoricalConstituents
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[IndicesHistoricalConstituents](finnhub/models/indices_historical_constituents.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[IndicesHistoricalConstituents](finnhub/models/indices_historical_constituents.py)</code> -- successful operation
...
```python
result = client.with_raw_response.insider_sentiment(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.insider_sentiment(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InsiderSentiments
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InsiderSentiments](finnhub/models/insider_sentiments.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InsiderSentiments](finnhub/models/insider_sentiments.py)</code> -- successful operation
...
```python
result = client.with_raw_response.insider_transactions(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.insider_transactions(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InsiderTransactions
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InsiderTransactions](finnhub/models/insider_transactions.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InsiderTransactions](finnhub/models/insider_transactions.py)</code> -- successful operation
...
```python
result = client.with_raw_response.institutional_ownership(symbol, cusip, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.institutional_ownership(symbol, cusip, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InstitutionalOwnership
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InstitutionalOwnership](finnhub/models/institutional_ownership.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InstitutionalOwnership](finnhub/models/institutional_ownership.py)</code> -- successful operation
...
```python
result = client.with_raw_response.institutional_portfolio(cik, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.institutional_portfolio(cik, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InstitutionalPortfolio
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InstitutionalPortfolio](finnhub/models/institutional_portfolio.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InstitutionalPortfolio](finnhub/models/institutional_portfolio.py)</code> -- successful operation
...
```python
result = client.with_raw_response.institutional_profile()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.institutional_profile()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InstitutionalProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InstitutionalProfile](finnhub/models/institutional_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InstitutionalProfile](finnhub/models/institutional_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.international_filings()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.international_filings()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[InternationalFiling]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[InternationalFiling](finnhub/models/international_filing.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[InternationalFiling](finnhub/models/international_filing.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.investment_themes(theme)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.investment_themes(theme)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InvestmentThemes
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InvestmentThemes](finnhub/models/investment_themes.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InvestmentThemes](finnhub/models/investment_themes.py)</code> -- successful operation
...
```python
result = client.with_raw_response.ipo_calendar(from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.ipo_calendar(from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Ipocalendar
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Ipocalendar](finnhub/models/ipocalendar.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Ipocalendar](finnhub/models/ipocalendar.py)</code> -- successful operation
...
```python
result = client.with_raw_response.isin_change(from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.isin_change(from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type IsinChange
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[IsinChange](finnhub/models/isin_change.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[IsinChange](finnhub/models/isin_change.py)</code> -- successful operation
...
```python
result = client.with_raw_response.market_holiday(exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.market_holiday(exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MarketHoliday
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MarketHoliday](finnhub/models/market_holiday.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MarketHoliday](finnhub/models/market_holiday.py)</code> -- successful operation
...
```python
result = client.with_raw_response.market_news(category)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.market_news(category)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[MarketNews]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[MarketNews](finnhub/models/market_news.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[MarketNews](finnhub/models/market_news.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.market_status(exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.market_status(exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MarketStatus
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MarketStatus](finnhub/models/market_status.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MarketStatus](finnhub/models/market_status.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_country_exposure()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_country_exposure()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundCountryExposure
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundCountryExposure](finnhub/models/mutual_fund_country_exposure.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundCountryExposure](finnhub/models/mutual_fund_country_exposure.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_eet(isin)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_eet(isin)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundEet
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundEet](finnhub/models/mutual_fund_eet.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundEet](finnhub/models/mutual_fund_eet.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_eet_pai(isin)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_eet_pai(isin)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundEetPai
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundEetPai](finnhub/models/mutual_fund_eet_pai.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundEetPai](finnhub/models/mutual_fund_eet_pai.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_holdings()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_holdings()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundHoldings
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundHoldings](finnhub/models/mutual_fund_holdings.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundHoldings](finnhub/models/mutual_fund_holdings.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_profile()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_profile()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundProfile
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundProfile](finnhub/models/mutual_fund_profile.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundProfile](finnhub/models/mutual_fund_profile.py)</code> -- successful operation
...
```python
result = client.with_raw_response.mutual_fund_sector_exposure()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.mutual_fund_sector_exposure()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MutualFundSectorExposure
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[MutualFundSectorExposure](finnhub/models/mutual_fund_sector_exposure.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[MutualFundSectorExposure](finnhub/models/mutual_fund_sector_exposure.py)</code> -- successful operation
...
```python
result = client.with_raw_response.news_sentiment(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.news_sentiment(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type NewsSentiment
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[NewsSentiment](finnhub/models/news_sentiment.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[NewsSentiment](finnhub/models/news_sentiment.py)</code> -- successful operation
...
```python
result = client.with_raw_response.newsroom(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.newsroom(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Newsroom
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Newsroom](finnhub/models/newsroom.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Newsroom](finnhub/models/newsroom.py)</code> -- successful operation
...
```python
result = client.with_raw_response.ownership(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.ownership(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Ownership
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Ownership](finnhub/models/ownership.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Ownership](finnhub/models/ownership.py)</code> -- successful operation
...
```python
result = client.with_raw_response.pattern_recognition(symbol, resolution)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pattern_recognition(symbol, resolution)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PatternRecognition
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[PatternRecognition](finnhub/models/pattern_recognition.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[PatternRecognition](finnhub/models/pattern_recognition.py)</code> -- successful operation
...
```python
result = client.with_raw_response.press_releases(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.press_releases(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PressRelease
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[PressRelease](finnhub/models/press_release.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[PressRelease](finnhub/models/press_release.py)</code> -- successful operation
...
```python
result = client.with_raw_response.price_metrics(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.price_metrics(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PriceMetrics
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[PriceMetrics](finnhub/models/price_metrics.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[PriceMetrics](finnhub/models/price_metrics.py)</code> -- successful operation
...
```python
result = client.with_raw_response.price_target(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.price_target(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PriceTarget
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[PriceTarget](finnhub/models/price_target.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[PriceTarget](finnhub/models/price_target.py)</code> -- successful operation
...
```python
result = client.with_raw_response.quote(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.quote(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Quote
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Quote](finnhub/models/quote.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Quote](finnhub/models/quote.py)</code> -- successful operation
...
```python
result = client.with_raw_response.recommendation_trends(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.recommendation_trends(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[RecommendationTrend]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[RecommendationTrend](finnhub/models/recommendation_trend.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[RecommendationTrend](finnhub/models/recommendation_trend.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.revenue_breakdown()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.revenue_breakdown()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type RevenueBreakdown
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[RevenueBreakdown](finnhub/models/revenue_breakdown.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[RevenueBreakdown](finnhub/models/revenue_breakdown.py)</code> -- successful operation
...
```python
result = client.with_raw_response.revenue_breakdown2(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.revenue_breakdown2(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type RevenueBreakdown2
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[RevenueBreakdown2](finnhub/models/revenue_breakdown2.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[RevenueBreakdown2](finnhub/models/revenue_breakdown2.py)</code> -- successful operation
...
```python
result = client.with_raw_response.search_in_filing()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.search_in_filing()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type InFilingResponse
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[InFilingResponse](finnhub/models/in_filing_response.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[InFilingResponse](finnhub/models/in_filing_response.py)</code> -- successful operation
...
```python
result = client.with_raw_response.sector_metric(region)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.sector_metric(region)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SectorMetric
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SectorMetric](finnhub/models/sector_metric.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SectorMetric](finnhub/models/sector_metric.py)</code> -- successful operation
...
```python
result = client.with_raw_response.similarity_index()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.similarity_index()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SimilarityIndex
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SimilarityIndex](finnhub/models/similarity_index.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SimilarityIndex](finnhub/models/similarity_index.py)</code> -- successful operation
...
```python
result = client.with_raw_response.social_sentiment(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.social_sentiment(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SocialSentiment
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SocialSentiment](finnhub/models/social_sentiment.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SocialSentiment](finnhub/models/social_sentiment.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_basic_dividends(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_basic_dividends(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Dividends2
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[Dividends2](finnhub/models/dividends2.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[Dividends2](finnhub/models/dividends2.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_bidask(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_bidask(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type LastBidAsk
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[LastBidAsk](finnhub/models/last_bid_ask.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[LastBidAsk](finnhub/models/last_bid_ask.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_candles(symbol, resolution, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type StockCandles
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[StockCandles](finnhub/models/stock_candles.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[StockCandles](finnhub/models/stock_candles.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_dividends(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_dividends(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[Dividends]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[Dividends](finnhub/models/dividends.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[Dividends](finnhub/models/dividends.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.stock_lobbying(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_lobbying(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type LobbyingResult
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[LobbyingResult](finnhub/models/lobbying_result.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[LobbyingResult](finnhub/models/lobbying_result.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_nbbo(symbol, date, limit, skip)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_nbbo(symbol, date, limit, skip)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type HistoricalNbbo
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[HistoricalNbbo](finnhub/models/historical_nbbo.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[HistoricalNbbo](finnhub/models/historical_nbbo.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_presentation(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_presentation(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type StockPresentation
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[StockPresentation](finnhub/models/stock_presentation.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[StockPresentation](finnhub/models/stock_presentation.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_splits(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_splits(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[Split]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[Split](finnhub/models/split.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[Split](finnhub/models/split.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.stock_symbols(exchange)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_symbols(exchange)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[StockSymbol]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[StockSymbol](finnhub/models/stock_symbol.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[StockSymbol](finnhub/models/stock_symbol.py)&#93;</code> -- successful operation
...
```python
result = client.with_raw_response.stock_tick(symbol, date, limit, skip)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_tick(symbol, date, limit, skip)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TickData
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[TickData](finnhub/models/tick_data.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[TickData](finnhub/models/tick_data.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_usa_spending(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_usa_spending(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type UsaSpendingResult
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[UsaSpendingResult](finnhub/models/usa_spending_result.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[UsaSpendingResult](finnhub/models/usa_spending_result.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_uspto_patent(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_uspto_patent(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type UsptoPatentResult
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[UsptoPatentResult](finnhub/models/uspto_patent_result.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[UsptoPatentResult](finnhub/models/uspto_patent_result.py)</code> -- successful operation
...
```python
result = client.with_raw_response.stock_visa_application(symbol, from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.stock_visa_application(symbol, from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type VisaApplicationResult
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[VisaApplicationResult](finnhub/models/visa_application_result.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[VisaApplicationResult](finnhub/models/visa_application_result.py)</code> -- successful operation
...
```python
result = client.with_raw_response.supply_chain_relationships(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.supply_chain_relationships(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SupplyChainRelationships
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SupplyChainRelationships](finnhub/models/supply_chain_relationships.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SupplyChainRelationships](finnhub/models/supply_chain_relationships.py)</code> -- successful operation
...
```python
result = client.with_raw_response.support_resistance(symbol, resolution)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.support_resistance(symbol, resolution)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SupportResistance
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SupportResistance](finnhub/models/support_resistance.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SupportResistance](finnhub/models/support_resistance.py)</code> -- successful operation
...
```python
result = client.with_raw_response.symbol_change(from_, to)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.symbol_change(from_, to)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SymbolChange
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SymbolChange](finnhub/models/symbol_change.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SymbolChange](finnhub/models/symbol_change.py)</code> -- successful operation
...
```python
result = client.with_raw_response.symbol_search(q)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.symbol_search(q)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type SymbolLookup
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[SymbolLookup](finnhub/models/symbol_lookup.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[SymbolLookup](finnhub/models/symbol_lookup.py)</code> -- successful operation
...
```python
result = client.with_raw_response.technical_indicator(symbol, resolution, from_, to, indicator)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.technical_indicator(symbol, resolution, from_, to, indicator)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Any
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;Any, [RawError](finnhub/core/results.py)&#93;</code>
...
```python
result = client.with_raw_response.transcripts(id)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.transcripts(id)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EarningsCallTranscripts
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EarningsCallTranscripts](finnhub/models/earnings_call_transcripts.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EarningsCallTranscripts](finnhub/models/earnings_call_transcripts.py)</code> -- successful operation
...
```python
result = client.with_raw_response.transcripts_list(symbol)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.transcripts_list(symbol)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type EarningsCallTranscriptsList
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;[EarningsCallTranscriptsList](finnhub/models/earnings_call_transcripts_list.py), [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>[EarningsCallTranscriptsList](finnhub/models/earnings_call_transcripts_list.py)</code> -- successful operation
...
```python
result = client.with_raw_response.upgrade_downgrade()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.upgrade_downgrade()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[UpgradeDowngrade]
    case Failure(error=error):
...
**Returns**: <code>[ApiResult](finnhub/core/results.py)&#91;list&#91;[UpgradeDowngrade](finnhub/models/upgrade_downgrade.py)&#93;, [RawError](finnhub/core/results.py)&#93;</code>

**On `Success`**: `payload` is <code>list&#91;[UpgradeDowngrade](finnhub/models/upgrade_downgrade.py)&#93;</code> -- successful operation
